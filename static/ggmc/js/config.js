var INSTALLED={
	...
	"guyana":{
		...
		"width":2,
		"polygon_features":[
			{"filename":"essequibo_river.geojson","color":"rgba(255,0,0,1)","fill":'rgba(0,0,255,1)','width':1},
			{"filename":"rupununi.geojson","color":"rgba(255,255,0,1)","fill":'rgba(0,0,255,1)','width':1},
		],
		"point_features":[
			{"filename":"georgetown.geojson"},
		],
	},
	"iceland":{
